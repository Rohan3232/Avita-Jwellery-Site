                        ...
                        return (
                            <Carousel.Item key={key}>
                                <NavLink to={{
                                    ...
                                    <img  loading='lazy' width={400} height={400} src={carouselImages[index]} alt={index.split('.')[0]} style={{ width: "100%" }}></img>
                    ...
                    <div className="cards-thumbnails row">  
                        {Object.keys(thumbnailsImages).map((index, key) => {
                            return (<div className="col-lg-4 card" key={key}><NavLink to={this.addLink(key)}>
                                <img loading='lazy' width={400} height={400} src={thumbnailsImages[index]} className="card-img-top" alt="card1"></img></NavLink>
                            </div>)
                        })}
                    </div>
                    <div className="cards-collection row">
                        {Object.keys(collectionsImages).map((index, key) => {
                            return (<div key={key} className="col-lg-12 card" ><NavLink to='/products/Offers'>
                                <img loading='lazy'  width={400} height={400} src={collectionsImages[index]} className="card-img-top" alt="card1"></img>
                            </NavLink></div>)
                        })}
                    </div>
                </div>
